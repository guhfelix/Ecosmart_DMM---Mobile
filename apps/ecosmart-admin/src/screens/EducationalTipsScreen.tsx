...
export function EducationalTipsScreen({ items, onSave, onDelete, onBack }: Props) {
        ...
        ListHeaderComponent={
          <>
            <View style={styles.header}>
              ...
              <Text style={styles.subtitle}>Cadastre conteúdos educativos para orientar os cidadãos.</Text>
            </View>
            ...
            <View style={styles.form}>
              ...
              <TextInput
                ...
                placeholder="Ex.: Separe materiais recicláveis"
              ...
              <TextInput
                ...
                placeholder="Escreva a orientação educativa"
                placeholderTextColor={colors.muted}
                multiline
                numberOfLines={4}
              />
