...
export function listProjectTasks(dcOrVars, varsOrOptions, options) {
...
export const listTaskCommentsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function listTaskComments(dcOrVars, varsOrOptions, options) {
