...
/**
 * Tela de Autenticação do Cidadão.
 * Oferece alternância entre Login com Google (Firebase Auth), E-mail/Senha, Cadastro e Recuperação de Senha.
 * Valida estritamente perfis (RBAC) e bloqueia acessos indevidos.
 */
export function AuthScreen({
  ...
  const handleRequestCode = () => {
    const res = requestPasswordReset(forgotEmail, 'cidadao', registeredUsers);
      ...
      >
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Acesse sua conta para registrar descartes sustentáveis.</Text>
          </View>
            ...
            {forgotStep === 1 ? (
              <>
                <Text style={styles.modalSubtitle}>
                  Informe seu e-mail de cadastro para receber o código de segurança.
                </Text>
